...
#include "arduinobot_msg/srv/detail/add_two_ints__rosidl_typesupport_fastrtps_c.h"
...
using _AddTwoInts_Request__ros_msg_type = arduinobot_msg__srv__AddTwoInts_Request;
...
size_t get_serialized_size_arduinobot_msg__srv__AddTwoInts_Request(
  const void * untyped_ros_message,
...
static uint32_t _AddTwoInts_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_arduinobot_msg__srv__AddTwoInts_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arduinobot_msg
size_t max_serialized_size_arduinobot_msg__srv__AddTwoInts_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _AddTwoInts_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arduinobot_msg__srv__AddTwoInts_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arduinobot_msg, srv, AddTwoInts_Request)() {
...
using _AddTwoInts_Response__ros_msg_type = arduinobot_msg__srv__AddTwoInts_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arduinobot_msg
size_t get_serialized_size_arduinobot_msg__srv__AddTwoInts_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AddTwoInts_Response__ros_msg_type * ros_message = static_cast<const _AddTwoInts_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_arduinobot_msg__srv__AddTwoInts_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arduinobot_msg
size_t max_serialized_size_arduinobot_msg__srv__AddTwoInts_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _AddTwoInts_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arduinobot_msg__srv__AddTwoInts_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arduinobot_msg, srv, AddTwoInts_Response)() {
...
// already included above
// #include "arduinobot_msg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "arduinobot_msg/srv/add_two_ints.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arduinobot_msg, srv, AddTwoInts)() {
