...
public:
    ...
    {
        service_ = create_service<arduinobot_msg::srv::AddTwoInts>("add_two_ints", std::bind(&SimpleServiceServer::serviceCallback, this, _1, _2));
        RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "Service add_two_ints is Ready");
    }

private:
    rclcpp::Service<arduinobot_msg::srv::AddTwoInts>::SharedPtr service_;

    void serviceCallback(
        const std::shared_ptr<arduinobot_msg::srv::AddTwoInts::Request> req,
        const std::shared_ptr<arduinobot_msg::srv::AddTwoInts::Response> res)
    {
